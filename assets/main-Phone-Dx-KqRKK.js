...
`,[po(x("&","--n-merged-color: var(--n-color-modal);")),xo(x("&","--n-merged-color: var(--n-color-popover);")),x("img",`
 ...
 align-items: center;
 justify-content: center;
 `,[Re({top:"50%",originalTransform:"translateY(-50%)"})]),Go()]),m("content",`
 display: flex;
 align-items: center;
 flex-wrap: nowrap;
 min-width: 0;
