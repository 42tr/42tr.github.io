import{i as ee,h as no,o as Me,c as io,u as pe,r as Z,N as ao,b as Le,g as lo,n as Pe,V as so,p as co,q as ho,t as uo,v as fo,j as We,k as go,w as mo,d as Oe,m as vo,x as bo}from"./main-_common-DtcbxNVa.js";import{c as he,a as x,b as Ve,f as $,h as m,e as Ae,k as _,g as P,q as te,i as X,u as L,j as re,o as h,m as po,n as xo,d as Ne,v as yo,w as Co,t as zo}from"./main-light-DrXE_YRv.js";import{e as wo,F as Ge,D as De,s as ce,u as Te,g as O,i as Ie,d as H,m as c,p as Ke,E as $o,t as Ee,r as N,G as So,j as ko,n as _o,w as Po,q as Bo,o as ue,c as fe,a as ne}from"./main-runtime-dom.esm-bundler-D_rBPd7M.js";let He=!1;function Ro(){if(ee&&window.CSS&&!He&&(He=!0,"registerProperty"in(window==null?void 0:window.CSS)))try{CSS.registerProperty({name:"--n-color-start",syntax:"<color>",inherits:!1,initialValue:"#0000"}),CSS.registerProperty({name:"--n-color-end",syntax:"<color>",inherits:!1,initialValue:"#0000"})}catch{}}function de(e){return e.replace(/#|\(|\)|,|\s|\./g,"_")}function Be(e,o=!0,r=[]){return e.forEach(i=>{if(i!==null){if(typeof i!="object"){(typeof i=="string"||typeof i=="number")&&r.push(wo(String(i)));return}if(Array.isArray(i)){Be(i,o,r);return}if(i.type===Ge){if(i.children===null)return;Array.isArray(i.children)&&Be(i.children,o,r)}else{if(i.type===De&&o)return;r.push(i)}}}),r}function To(e,o="default",r=[]){const t=e.$slots[o];return t===void 0?r:t()}const je=he("n-form-item");function Io(e,{defaultSize:o="medium",mergedSize:r,mergedDisabled:i}={}){const t=ce(je,null);Te(je,null);const a=O(r?()=>r(t):()=>{const{size:l}=e;if(l)return l;if(t){const{mergedSize:p}=t;if(p.value!==void 0)return p.value}return o}),f=O(i?()=>i(t):()=>{const{disabled:l}=e;return l!==void 0?l:t?t.disabled.value:!1}),n=O(()=>{const{status:l}=e;return l||(t==null?void 0:t.mergedValidationStatus.value)});return Ie(()=>{t&&t.restoreValidation()}),{mergedSizeRef:a,mergedDisabledRef:f,mergedStatusRef:n,nTriggerFormBlur(){t&&t.handleContentBlur()},nTriggerFormChange(){t&&t.handleContentChange()},nTriggerFormFocus(){t&&t.handleContentFocus()},nTriggerFormInput(){t&&t.handleContentInput()}}}const qe=H({name:"BaseIconSwitchTransition",setup(e,{slots:o}){const r=no();return()=>c(Ke,{name:"icon-switch-transition",appear:r.value},o)}}),{cubicBezierEaseInOut:Eo}=Ve;function Re({originalTransform:e="",left:o=0,top:r=0,transition:i=`all .3s ${Eo} !important`}={}){return[x("&.icon-switch-transition-enter-from, &.icon-switch-transition-leave-to",{transform:`${e} scale(0.75)`,left:o,top:r,opacity:0}),x("&.icon-switch-transition-enter-to, &.icon-switch-transition-leave-from",{transform:`scale(1) ${e}`,left:o,top:r,opacity:1}),x("&.icon-switch-transition-enter-active, &.icon-switch-transition-leave-active",{transformOrigin:"center",position:"absolute",left:o,top:r,transition:i})]}const Oo=H({name:"FadeInExpandTransition",props:{appear:Boolean,group:Boolean,mode:String,onLeave:Function,onAfterLeave:Function,onAfterEnter:Function,width:Boolean,reverse:Boolean},setup(e,{slots:o}){function r(n){e.width?n.style.maxWidth=`${n.offsetWidth}px`:n.style.maxHeight=`${n.offsetHeight}px`,n.offsetWidth}function i(n){e.width?n.style.maxWidth="0":n.style.maxHeight="0",n.offsetWidth;const{onLeave:l}=e;l&&l()}function t(n){e.width?n.style.maxWidth="":n.style.maxHeight="";const{onAfterLeave:l}=e;l&&l()}function a(n){if(n.style.transition="none",e.width){const l=n.offsetWidth;n.style.maxWidth="0",n.offsetWidth,n.style.transition="",n.style.maxWidth=`${l}px`}else if(e.reverse)n.style.maxHeight=`${n.offsetHeight}px`,n.offsetHeight,n.style.transition="",n.style.maxHeight="0";else{const l=n.offsetHeight;n.style.maxHeight="0",n.offsetWidth,n.style.transition="",n.style.maxHeight=`${l}px`}n.offsetWidth}function f(n){var l;e.width?n.style.maxWidth="":e.reverse||(n.style.maxHeight=""),(l=e.onAfterEnter)===null||l===void 0||l.call(e)}return()=>{const{group:n,width:l,appear:p,mode:g}=e,y=n?$o:Ke,k={name:l?"fade-in-width-expand-transition":"fade-in-height-expand-transition",appear:p,onEnter:a,onAfterEnter:f,onBeforeLeave:r,onLeave:i,onAfterLeave:t};return n||(k.mode=g),c(y,k,o)}}}),Ho=x([x("@keyframes rotator",`
 0% {
...
`,[po(x("&","--n-merged-color: var(--n-color-modal);")),xo(x("&","--n-merged-color: var(--n-color-popover);")),x("img",`
 ...
 align-items: center;
 justify-content: center;
 `,[Re({top:"50%",originalTransform:"translateY(-50%)"})]),No()]),m("content",`
 display: flex;
 align-items: center;
 flex-wrap: nowrap;
 min-width: 0;
