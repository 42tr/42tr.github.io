...
`,[$("strong",`
 ...
 background-color .3s var(--n-bezier),
 color .3s var(--n-bezier);
`,[zo(x("&","--n-merged-color: var(--n-color-modal);")),wo(x("&","--n-merged-color: var(--n-color-popover);")),x("img",`
 width: 100%;
 height: 100%;
 `),g("text",`
 white-space: nowrap;
...
`,[$("color-transition",{transition:"color .3s var(--n-bezier)"}),$("depth",{color:"var(--n-color)"},[x("svg",{opacity:"var(--n-opacity)",transition:"opacity .3s var(--n-bezier)"})]),x("svg",{height:"1em",width:"1em"})]),it=Object.assign(Object.assign({},L.props),{depth:[String,Number],size:[Number,String],color:String,component:Object}),Wt=H({_n_icon__:!0,name:"Icon",inheritAttrs:!1,props:it,setup(e){const{mergedClsPrefixRef:o,inlineThemeDisabled:r}=Y(e),i=L("Icon","-icon",nt,fo,e,o),t=E(()=>{const{depth:d}=e,{common:{cubicBezierEaseInOut:n},self:l}=i.value;if(d!==void 0){const{color:b,[`opacity${d}Depth`]:v}=l;return{"--n-bezier":n,"--n-color":b,"--n-opacity":v}}return{"--n-bezier":n,"--n-color":"","--n-opacity":""}}),a=r?te("icon",E(()=>`${e.depth||"d"}`),t,e):void 0;return{mergedClsPrefix:o,mergedStyle:E(()=>{const{size:d,color:n}=e;return{fontSize:Ve(d),color:n}}),cssVars:r?void 0:t,themeClass:a==null?void 0:a.themeClass,onRender:a==null?void 0:a.onRender}},render(){var e;const{$parent:o,depth:r,mergedClsPrefix:i,component:t,onRender:a,themeClass:d}=this;return!((e=o==null?void 0:o.$options)===null||e===void 0)&&e._n_icon__&&Po("icon","don't wrap `n-icon` inside `n-icon`"),a==null||a(),c("i",Bo(this.$attrs,{role:"img",class:[`${i}-icon`,d,{[`${i}-icon--depth`]:r,[`${i}-icon--color-transition`]:r!==void 0}],style:[this.cssVars,this.mergedStyle]}),t?c(t):this.$slots)}}),at=w("divider",`
 position: relative;
 display: flex;
 width: 100%;
 box-sizing: border-box;
